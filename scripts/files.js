...
async function loadFiles(path = '') {
  ...
  try {
    ...
    listElement.innerHTML = '<tr><td colspan="3" style="color:red; padding:10px 8px;">Failed to connect to the file server. Make sure the server and tunnel are running.</td></tr>';
  }
}
